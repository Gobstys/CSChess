	...
	public class GameUI
	{
        ...
        public void LoadGame()
        {
            ...
            if (openDialog.ShowDialog() == DialogResult.OK)
            {
				...
				DialogResult dialog = MessageBox.Show("Would you like to play the custom gamemode?", "Exit", MessageBoxButtons.YesNo);
				if (dialog == DialogResult.Yes)
				{
					ChessGame.Reset(true);  // Reset the game board
				}
		...
		public void NewGame()
		{
			...
			if (NewGameDlg.bStartGame)
			{
				...
				DialogResult dialog = MessageBox.Show("Would you like to play the regular gamemode?", "Gamemode Choice", MessageBoxButtons.YesNo);
				if (dialog == DialogResult.Yes)
				{
					ChessGame.Reset(true);  // Reset the game board
				}
